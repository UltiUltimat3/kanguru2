...
function draw() {
  ...
  if (gameState===PLAY){
   ...
   console.log(kangaroo.y)
    ...
    //defina o tempo de vida dos objetos do jogo para que nunca sejam destruídos
  ...
  if(score >= 5){
    ...
    stroke(3);
    fill("black");
    text("VOCE VENCEU O JOGO! ", 70,200);
    gameState = WIN;
  }
}
...
function spawnShrubs() {
  ...
  if (frameCount % 150 === 0) {
    ...
    //atribua escala e vida ao arbusto       
    shrub.scale = 0.05;
...
function spawnObstacles() {
  if(frameCount % 120 === 0) {
    ...
    obstacle.scale = 0.15;
    //atribua escala e vida ao obstáculo          
